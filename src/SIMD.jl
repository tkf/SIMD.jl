...
Liks `Base.FastContiguousSubArray` but without requirement for linear
indexing (type parameter `L`).
...
"""
@inline _pointer(arr::Array, i, I) = pointer(arr, LinearIndices(arr)[i, I...])
@inline _pointer(arr::Base.FastContiguousSubArray, i, I) = pointer(arr, (i, I...))
@inline _pointer(arr::SubArray, i, I) =
